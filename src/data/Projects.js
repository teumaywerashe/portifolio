export const projectsData = [{
    ...
    {
        title: "Resource Hub",
        description: "A web based platform where students can find the details of all the ethiopian universities and the cources and departments they deliver",
    ...
    },
    {
        ...
        description: "A web based platform where students and stuff of a campus can report issue that they see in the campus",
    ...
    },
    {
        ...
        description: "A web based platform where users can buy and sell products online and make there payment through chapa",
